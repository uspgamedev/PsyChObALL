...
function run()
	...
	wait(4)
	enemy(range, 1, nil, 6, vc{width/2, 45}, vc{width/2, -30}, nil, mono, {50,205,50}, 0, 15)
	enemy(range, 1, nil, 6, vc{width/2, height - 45}, vc{width/2, height + 30}, nil, mono, {50,205,50}, 0, 15)
	enemy(range, 1, nil, 4, vc{45, height/2}, vc{-30, height/2}, nil, mono, {50,205,50}, 0, 15)
	enemy(range, 1, nil, 4, vc{width -45, height/2}, vc{width + 30, height/2}, nil, mono, {50,205,50}, 0, 15)
	wait(17)
